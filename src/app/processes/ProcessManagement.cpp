...
#include <sys/wait.h>
#include <atomic>
#include <fcntl.h>         // Use <fcntl.h> instead of <sys/fcntl.h>
#include <semaphore.h>
#include <thread>
#include <mutex>
...
ProcessManagement::ProcessManagement() {
    ...
    sharedMem->front = 0;
    sharedMem->rear = 0;
    sharedMem->size.store(0);  // ✅ FIXED: was incorrectly using `store(d:0)`
}
...
void ProcessManagement::executeTasks() {
    ...
    sharedMem->size.fetch_sub(1);  // ✅ FIXED: was using fetch_sub(op:1)
